...
func _run_suites() -> void:
    var kit := TestKit.new()
    var suites := {
        "standalone practice": "res://tests/test_practice.gd",
        "table audio": "res://tests/test_audio_preview.gd",
        ...
        "projected world": "res://tests/test_projected_world.gd",
        "room presentation": "res://tests/test_room_presentation.gd",
    }
    for name in suites:
