...
adjudication; teaching and town access for 19×19 (development play already has overview/zoom); `world.gd` and `go_match.gd` are over the line-count convention; audio has never been heard by an assistant.
