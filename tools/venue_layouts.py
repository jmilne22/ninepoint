...
def dress(name, data):
    ...
    if name=='attic':
        ...
        for sign in data['signs']:
            if sign['tile']==[1,4]:sign.update(tile=[4,3],text='COMMUNITY CENTRE / SELA GO CLUB. Novices: lower west. Study: upper west. Class: east. Guest room upstairs.')
...
(4,8):'The stationer is closed. Your stairs are beside the shutters. A note asks for parcels to be left at the laundry; the upstairs bell is broken.',
(15,8):'THE KETTLE. Tea, lunch and a table in the shade. The Go club meets here; ask Wren by the window.',
(21,8):'LAUNDRY. Washing, drying and a folding counter. Please leave a machine free for work clothes.',
(25,8):'A sign at the snack window asks for the blue plates back. Three clean ones are stacked beside the paper bags.',
...
(1,4):'THE KETTLE. Please return empty cups to the counter. Wren helps new Go players by the window.',
...
'academy_hall':{(1,4):'COMMUNITY CENTRE / SELA GO CLUB. Register at the hall desk. Novices: lower west. Study: upper west. Class: east. Guest room upstairs.'},
...
'academy_dorm':{(9,6):'__DESK__A spare board on the guest-room desk. A ferry timetable is tucked underneath.',(2,6):'__BED__A made bed. Your bag fits underneath.'},
