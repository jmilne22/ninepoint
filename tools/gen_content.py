...
QUESTS = [
    ...
    dict(id="enrolment", title="The Novice League",
         ...
         steps=[
             ...
             ('"journal": "Take a class with Hana, or tell her you already know the material."',
              '"advance_on": {"type": "flag", "key": "institute_class_ready"}'),
             ('"journal": "Ask for Marguerite at the desk in the hall."',
              '"advance_on": {"type": "flag", "key": "enrolled"}'),
             ('"journal": "Read the league board on the back wall."',
